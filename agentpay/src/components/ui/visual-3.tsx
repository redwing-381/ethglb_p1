...
export function Visual3({
  ...
  gridColor = "#80808015",
  overlayTitle = "Forum Transaction Volume",
  overlayDescription = "Agent micro-payments per post",
  badges = ["+20 txns", "0 gas"],
}: Visual3Props) {
  ...
  return (
    <>
      ...
      <div className="relative h-[180px] w-[356px] overflow-hidden rounded-t-lg">
        ...
        <Layer2 color={mainColor} overlayTitle={overlayTitle} overlayDescription={overlayDescription} />
        <Layer1 color={mainColor} secondaryColor={secondaryColor} badges={badges} />
...
const Layer1: React.FC<LayerProps & { badges?: [string, string] }> = ({ color, secondaryColor, badges }) => {
  const [badge1, badge2] = badges || ["+20 txns", "0 gas"]
  return (
    <div
...
const Layer2: React.FC<{ color: string; overlayTitle?: string; overlayDescription?: string }> = ({ color, overlayTitle, overlayDescription }) => {
  return (
    <div
