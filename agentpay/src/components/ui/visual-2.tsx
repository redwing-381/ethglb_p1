...
export function Visual2({
  ...
  gridColor = "#80808015",
  overlayTitle = "Agent Payment Analytics",
  overlayDescription = "Gasless transfers via state channels",
  techTags,
}: Visual2Props) {
...
const Layer4: React.FC<LayerProps & { techTags?: string[] }> = ({ color, secondaryColor, hovered, techTags }) => {
  const defaultTags = ["Sepolia", "ENS", "Yellow", "Nitrolite", "wagmi", "viem"]
  const tags = techTags || defaultTags
  const positions = [
